...
class SourceNV21Renderer extends SourceRenderer {
	...
	private void initializeTexture() {
		...
		frameRenderBuffer
				.position(4 * (previewWidth / 2) * (previewHeight / 2));
		GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE_ALPHA,
				previewWidth / 2, previewHeight / 2, 0,
	...
	void initCameraRendering() {
		...
		cameraShaderID = OpenglUtil.createProgramFromShaderSrc(VERTEX_SHADER,
				FRAGMENT_SHADER);
		cameraVertexHandle = GLES20.glGetAttribLocation(cameraShaderID,
				"vertexPosition");
		cameraTexCoordHandle = GLES20.glGetAttribLocation(cameraShaderID,
				"vertexTexCoord");
		cameraYUniformHandle = GLES20.glGetUniformLocation(cameraShaderID,
				"videoFrameY");
		cameraUVUniformHandle = GLES20.glGetUniformLocation(cameraShaderID,
				"videoFrameUV");
		cameraMVPMatrixHandle = GLES20.glGetUniformLocation(cameraShaderID,
	...
	public final void draw() {
		...
		GLES20.glTexSubImage2D(GLES20.GL_TEXTURE_2D, 0, 0, 0, previewWidth,
				previewHeight, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE,
				frameRenderBuffer);
		...
		GLES20.glTexSubImage2D(GLES20.GL_TEXTURE_2D, 0, 0, 0, previewWidth / 2,
				previewHeight / 2, GLES20.GL_LUMINANCE_ALPHA,
				GLES20.GL_UNSIGNED_BYTE, frameRenderBuffer);
		...
		GLES20.glVertexAttribPointer(cameraVertexHandle, 3, GLES20.GL_FLOAT,
				false, 0, quadVertices);
		GLES20.glVertexAttribPointer(cameraTexCoordHandle, 2, GLES20.GL_FLOAT,
