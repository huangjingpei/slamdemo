...
class SourceRenderer {
	...
	protected int deviceOrientation = -1;// 0: Portrait , 1: LandLeft, 2:
											// UpSideDown,3: LandRight
	...
	protected double quadVerticesArray[] = { -1.0f, -1.0f, 0.0f, 1.0f, -1.0f,
			0.0f, 1.0f, 1.0f, 0.0f, -1.0f, 1.0f, 0.0f };

	protected double quadTexCoordsArray[] = { 0.0f, 1.0f, 1.0f, 1.0f, 1.0f,
			0.0f, 0.0f, 0.0f };
	...
	protected void configTexCoords() {
		 ...
		 */
		if (previewWidth == -1 || previewHeight == -1 || screenHeight == -1
				|| screenWidth == -1)
			return;
