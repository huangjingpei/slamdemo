...
public class ModelLines extends Widget {
    ...
    public void setModelLines(float[] modelLines, int linenum, int color){
        vertices = new float[linenum * 6];
        for(int i = 0; i < linenum * 6; ++i){
            vertices[i] = modelLines[i];
        }
        paintColor = color;
        initVertexData();
    }
    ...
    public void initVertexData() {
        ...
        float colors_original[] = {0.0f, 1.0f, 0.0f, 1f};
        switch (paintColor) {
            case 2://线条绿色
                colors_original = new float[]{0.0f, 1.0f, 0.0f, 1f};
                break;
            case 1://线条蓝
                colors_original = new float[]{0.0f, 0.0f, 1.0f, 1f};
                break;
            case 0:
                colors_original = new float[]{0.9f, 0.9f, 0.9f, 1f};
                break;
            default:
        }
