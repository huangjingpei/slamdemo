...
public class Border extends Widget {
	...
	public void initVertexData() {
		// ============================begin============================
		vCount = 18;
		float vertices[] = new float[] { -UNIT_SIZE, UNIT_SIZE, UNIT_SIZE,
				UNIT_SIZE, UNIT_SIZE, UNIT_SIZE, -UNIT_SIZE, -UNIT_SIZE,
				UNIT_SIZE, UNIT_SIZE, -UNIT_SIZE, UNIT_SIZE, -UNIT_SIZE,
				UNIT_SIZE, UNIT_SIZE, -UNIT_SIZE, UNIT_SIZE, 0, UNIT_SIZE,
				UNIT_SIZE, 0, UNIT_SIZE, -UNIT_SIZE, 0, -UNIT_SIZE, -UNIT_SIZE,
				0, -UNIT_SIZE, UNIT_SIZE, 0, -UNIT_SIZE, UNIT_SIZE, UNIT_SIZE,
				-UNIT_SIZE, -UNIT_SIZE, UNIT_SIZE, -UNIT_SIZE, -UNIT_SIZE, 0,
				UNIT_SIZE, -UNIT_SIZE, 0, UNIT_SIZE, -UNIT_SIZE, UNIT_SIZE,
				UNIT_SIZE, UNIT_SIZE, UNIT_SIZE, UNIT_SIZE, UNIT_SIZE, 0,
		...
		float colors[] = new float[] { colorR, colorG, colorB, colorA, colorR,
				colorG, colorB, colorA, colorR, colorG, colorB, colorA, colorR,
				colorG, colorB, colorA, colorR, colorG, colorB, colorA, colorR,
