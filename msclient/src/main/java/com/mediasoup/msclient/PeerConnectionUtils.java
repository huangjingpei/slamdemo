...
public class PeerConnectionUtils implements ExternalVideoCaptureHandler {
  ...
  private void createCamCapture(Context context) {
    ...
    mThreadChecker.checkIsOnValidThread();
      mCamCapture = ExternalVideoCapture.getInstance();
...
//            mCamCapture = new ExternalVideoCapture();
////            ((ExternalVideoCapture)mCamCapture).setExternalVideoFrameObserver(this);
////        } catch (IOException e) {
  ...
  public void setVideoInputFile(String inputFile) {
    ...
    public void onVideoFrame(VideoFrame frame) {
      ...
      // Copy i420 buffer into byte array
        ...
        //U Plane
        uBuffer.get(frameBuffer, height * width, width * height/4);
        //V Plane
        vBuffer.get(frameBuffer, height * width*5/4, width * height/4);
