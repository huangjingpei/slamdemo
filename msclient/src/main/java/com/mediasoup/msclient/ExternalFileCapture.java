...
public class ExternalFileCapture implements VideoCapturer {
    ...
    private ExternalVideoCaptureHandler mExternalVideoCaptureHandler;
    ...
    public ExternalFileCapture(String inputFile) throws IOException {
        try {
    ...
    public void tick() {
        ...
        if (mExternalVideoCaptureHandler != null) {
            mExternalVideoCaptureHandler.onVideoFrame(videoFrame);
        }
        videoFrame.release();
    }
    ...
    public void setExternalVideoFrameObserver(ExternalVideoCaptureHandler handler) {
        mExternalVideoCaptureHandler = handler;
    }
}